            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('page.appoint.report')}}" aria-expanded="false">
                        ...
                        <span class="hide-menu">Mes Rapports </span>
                    </a>
                </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="{{route('page.project.list')}}" aria-expanded="false">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item"><a href="{{route('page.tasks.list')}}" class="sidebar-link"><span
