                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            ...
                                            <tr {{$get_liste_employee['role_employee'] == 'admin' ? 'class="bg-danger"' : ''}}>
                                                ...
                                                <td>
                                                    <span class="text-white p-2 {{$get_liste_employee['status_id'] == 3 ? 'bg-success' : 'bg-warning'}}">
                                                        {{$get_liste_employee['lib_statut']}}
                                                    </span>
                                                </td>
                                                <td>
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-colored-header bg-primary">
                                                                    <h4 class="modal-title text-uppercase" id="primary-btn-eye-modalLabel">
                                                                        Détails sur {{$get_liste_employee['firstname_employee'].' '.$get_liste_employee['lastname_employee']}}
                                                                    </h4>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control" id="myroleSelect" required>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" required class="form-control" id="firstnametext" value="{{$get_liste_employee['firstname_employee']}}" aria-describedby="firstname" placeholder="First name">
                                                                                    <small id="firstname" class="form-text text-muted">Nom <span class="text-danger">*</span></small>
                                                                                </div>

                                                                                <div class="form-group">
                                                                                    <input type="text" required class="form-control" id="lastnametext" value="{{$get_liste_employee['lastname_employee']}}" aria-describedby="lastname" placeholder="Last name">
                                                                                    <small id="lastname" class="form-text text-muted">Prénom <span class="text-danger">*</span></small>
                                                                                </div>

                                                                                <div class="form-group">
                                                                                    <input type="email" required class="form-control" id="firstnametext" value="{{$get_liste_employee['email']}}" aria-describedby="firstname" placeholder="First name">
                                                                                    <small id="firstname" class="form-text text-muted">E-mail <span class="text-danger">*</span></small>
                                                                                </div>

                                                                                <div class="form-group">
                                                                                    <input type="tel" required class="form-control" id="teltext" value="{{$get_liste_employee['tel_employee']}}" aria-describedby="mytel" placeholder="Number phone">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <small for="myserviceSelect" class="form-text text-muted">Service <span class="text-danger">*</span></small>
                                                                                        @if (!empty($get_liste_service))
                                                                                            ...
                                                                                            <select class="form-control" id="myserviceSelect" required>

                                                                                                @foreach ($get_liste_service as $list_service)
                                                                                                    <option value="{{$list_service['libelle_service']}}" {{($list_service['id'] == $get_liste_employee['service_id'])?'selected':''}}>
                                                                                                        {{-- {{$list_service['libelle_service']}} --}}
                                                                                                        {{$list_service['id'].'=='.$get_liste_employee['service_id']}}
                                                                                                    </option>
                                                                                                @endforeach
                                                                                        ...
                                                                                        @else
                                                                                            ...
                                                                                            <select class="form-control" id="myserviceSelect" required>
                                                                                                <option>{{$get_liste_employee['libelle_service']}}</option>
                                                                                            </select>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    @if (!empty($get_liste_fonction))
                                                                                        ...
                                                                                        <select class="form-control" id="myfonctionSelect" required>

                                                                                            @foreach ($get_liste_fonction as $list_fonction)
                                                                                                <option value="{{$list_fonction['lib_function_occupied']}}" {{($list_fonction['id'] == $get_liste_employee['fonction_employee'])?'selected':''}}>
                                                                                    ...
                                                                                    @else
                                                                                        ...
                                                                                        <select class="form-control" id="myfonctionSelect" required>
                                                                                            <option>{{$get_liste_employee['lib_function_occupied']}}</option>
                                                                                        </select>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="date" required class="form-control" id="datetimelocal" 
                                                                                        value="{{ \Carbon\Carbon::createFromFormat('d/m/Y', $get_liste_employee['date_of_birth'])->format('Y-m-d') }}" 
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <input type="text" required class="form-control" id="locationbirthtext" value="{{$get_liste_employee['place_of_birth']}}" aria-describedby="mylocation" placeholder="Location birth">
                                                    ...
                                                    <button class="btn btn-sm btn-secondary" title="Nouveau mot de passe de {{$get_liste_employee['firstname_employee']}}" data-toggle="modal" data-target="#new-password-modal{{$get_liste_employee['code_employee']}}">
                                                        <i class="fas fa-key"></i>
                                                    </button>

                                                    <!-- New password modal content -->
                                                    <div id="new-password-modal{{$get_liste_employee['code_employee']}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-colored-header bg-secondary">
                                                                    <h4 class="modal-title text-uppercase" id="new-password-modalLabel">
                                                                        <img class="mr-2" src="{{asset('assets/assets/images/logo-icon.png')}}" alt="" height="20"> Changement de mot de passe
                                                                    </h4>
                                                                    <button type="button" class="close" data-dismiss="modal"
                                                                        aria-hidden="true">&times;</button>
                                                                </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-danger text-white">
                                                                    <h4 class="modal-title" id="myCenterModalLabel">Confirmation du statut de compte</h4>
                                                                    <button type="button" class="close" data-dismiss="modal"
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-secondary">Desactiver</button>
                                                                </div>
                                                            </div><!-- /.modal-content -->
                                                        </div><!-- /.modal-dialog -->
                                                    </div><!-- /.modal -->
