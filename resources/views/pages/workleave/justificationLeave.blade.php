        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Liste des justifications</h4>
                            <h6 class="card-subtitle">Cette section affiche les justifications soumises par les employés, incluant les motifs et les documents associés pour chaque demande.</h6>

                            <div class="d-flex justify-content-end mb-3">
                                <a href="{{route('page.worker.add')}}" class="btn btn-primary" title="Ajouter un nouvel employé">
                                    <i class="fas fa-plus-circle"></i> Justification
                                </a>
                            </div>
