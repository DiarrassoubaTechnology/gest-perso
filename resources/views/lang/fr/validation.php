...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez définir des messages de validation personnalisés pour
    | des attributs spécifiques. Par exemple, pour personnaliser le message
    | de validation pour le champ "password", vous pouvez faire comme ceci :
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez définir des attributs personnalisés pour vos champs
    | afin de rendre les messages d'erreur plus conviviaux. Par exemple, vous
    | pouvez personnaliser "email" en "adresse e-mail" pour l'afficher dans
